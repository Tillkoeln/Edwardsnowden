...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        listTransactions->setGeometry(QRect(13, 45, 351, 281));
        ...
        label_6->setGeometry(QRect(180, 150, 201, 311));
        label_6->setPixmap(QPixmap(QString::fromUtf8(":/icons/overview")));
        layoutWidget = new QWidget(frame_2);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(0, 0, 255, 22));
        ...
        labelTransactionsStatus = new QLabel(layoutWidget);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        label_5->setText(QApplication::translate("OverviewPage", "Storage Vault", 0));
#ifndef QT_NO_TOOLTIP
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the EdwardSnowdenCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the EdwardSnowdenCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
