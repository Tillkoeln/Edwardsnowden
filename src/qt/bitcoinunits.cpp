...
QString BitcoinUnits::name(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("pesc");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("esc (1 : 1)");
    case mBTC: return QString("mesc (1 / 1,000)");
    case uBTC: return QString("pesc (1 / 1,000,000)");
    //case nBTC: return QString("Nanogramweight EdwardSnowdenCoin (1 / 1,000,000,000) STILL IN RESEARCH PHASE");
    default: return QString("???");
    }
}
